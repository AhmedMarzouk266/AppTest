...
<form action="<?= $action ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="title" placeholder="Title.." value="<?= $answer->title ?>"
                   class="form-control">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select name="quest_id" class="custom-select form-control">
                <option disabled selected value> -- select an option -- </option>
                <?php foreach ($questions as $question) { ?>
                    <option value="<?= $question->id ?>" <?php if ($question->id == $answer->quest_id) {
                        echo 'selected';
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="file" name="images" placeholder="image src .." id="filePhoto"><br/><br/>
